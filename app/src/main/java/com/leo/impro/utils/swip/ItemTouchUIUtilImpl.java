    ...
    static class Lollipop extends Honeycomb {
        ...
        public void onDraw(Canvas c, RecyclerView recyclerView, View view,
            ...
            if (isCurrentlyActive) {
                Object originalElevation = view.getTag(com.lihang.nbadapter.R.id.item_touch_helper_previous_elevation);
                if (originalElevation == null) {
                    originalElevation = ViewCompat.getElevation(view);
                    float newElevation = 1f + findMaxElevation(recyclerView, view);
                    ViewCompat.setElevation(view, newElevation);
                    view.setTag(com.lihang.nbadapter.R.id.item_touch_helper_previous_elevation, originalElevation);
                }
            }
        ...
        public void clearView(View view) {
            final Object tag = view.getTag(com.lihang.nbadapter.R.id.item_touch_helper_previous_elevation);
            if (tag != null && tag instanceof Float) {
                ViewCompat.setElevation(view, (Float) tag);
            }
            view.setTag(com.lihang.nbadapter.R.id.item_touch_helper_previous_elevation, null);
