...
public final class EmojiconHandler {
    ...
    public static final SparseIntArray sEmojisMap = new SparseIntArray(1029);
...
//        Emoji.fromChars("\u0023\u20e3"),
        ...
        sEmojisMap.put(R.drawable.dding1, R.drawable.dding1);
        sEmojisMap.put(R.drawable.dding2, R.drawable.dding2);
        sEmojisMap.put(R.drawable.dding3, R.drawable.dding3);
        sEmojisMap.put(R.drawable.dding4, R.drawable.dding4);
        sEmojisMap.put(R.drawable.dding5, R.drawable.dding5);
        sEmojisMap.put(R.drawable.dding6, R.drawable.dding6);
        sEmojisMap.put(R.drawable.dding7, R.drawable.dding7);
        sEmojisMap.put(R.drawable.dding8, R.drawable.dding8);
        sEmojisMap.put(R.drawable.dding9, R.drawable.dding9);
        sEmojisMap.put(R.drawable.dding10, R.drawable.dding10);
        sEmojisMap.put(R.drawable.dding11, R.drawable.dding11);
        sEmojisMap.put(R.drawable.dding12, R.drawable.dding12);
        sEmojisMap.put(R.drawable.dding13, R.drawable.dding13);
        sEmojisMap.put(R.drawable.dding14, R.drawable.dding14);
        sEmojisMap.put(R.drawable.dding15, R.drawable.dding15);
        sEmojisMap.put(R.drawable.dding16, R.drawable.dding16);
        sEmojisMap.put(R.drawable.dding17, R.drawable.dding17);
        sEmojisMap.put(R.drawable.dding18, R.drawable.dding18);
        sEmojisMap.put(R.drawable.dding19, R.drawable.dding19);
        sEmojisMap.put(R.drawable.dding20, R.drawable.dding20);
    }
...
//                    Integer imgRes = R.drawable.d_hehe;
//                    if (imgRes != null) {
...
//            }
    ...
    public static boolean getEmotionContent(String source) {
